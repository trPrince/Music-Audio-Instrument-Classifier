...
def save_sample(sample, rate, target_dir, fn, ix):
    fn = fn.split('.wav')[0]
    dst_path = os.path.join(target_dir.split('.')[0], fn+'_{}.wav'.format(str(ix).zfill(3)))
    ...
    for _cls in classes:
        ...
        for fn in tqdm(os.listdir(src_dir)):
            ...
            if os.path.isdir(src_fn):
                 #('{}/{}'.format(src_dir,fn))
                for f in (os.listdir(src_fn)):
                    src_fname = os.path.join(src_fn, f)
                    rate, wav = downsample_mono(src_fname, args.sr)
                    ...
                    if wav.shape[0] < delta_sample:
                        ...
                        save_sample(sample, rate, target_dir, f, 0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--src_root', type=str, default='wavfiles/training',
